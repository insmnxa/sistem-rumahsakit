...
@section('content')
    <h1 class="text-4xl font-bold mb-4">Spesialisasi Create</h1>

    <button class="btn btn-link" type="button"
        onclick="location.href='<?= base_url('index.php/admin/spesialisasi') ?>'">Back</button>

    <form action="<?= base_url('index.php/admin/spesialisasi/create') ?>" method="post">
        <label class="form-control w-full max-w-sm">
            <div class="label">
                <span class="label-text">Spesialisasi</span>
            </div>
            <input type="text" name="nama" placeholder="Spesialisasi disini"
